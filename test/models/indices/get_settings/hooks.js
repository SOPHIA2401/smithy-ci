...
hooks.before("/{index}/_settings > GET > 200 > application/json",function(transactions,done) {
...
hooks.after("/{index}/_settings > GET > 200 > application/json",function(transactions,done){
...
hooks.before("/{index}/_settings/{setting} > GET > 200 > application/json",function(transactions,done) {
    transactions.expected.headers['Content-Type'] =  "application/json; charset=UTF-8";
...
hooks.after("/{index}/_settings/{setting} > GET > 200 > application/json",function(transactions,done){
